...
public class ValueInjector {
    ...
    public static Double getDoubleValueFromElement(XMLStreamReader reader) throws XMLStreamException {
    ...
    public static Double getDoubleValueFromElement(XMLStreamReader reader, String elementName){
    ...
    public static Integer getIntegerValueFromElement(XMLStreamReader reader) throws XMLStreamException {
        String value = getValueFromXml(reader);
        Integer result = Integer.parseInt(value);
    ...
    public static Boolean getBooleanValueFromElement(XMLStreamReader reader) throws XMLStreamException {
        String value = getValueFromXml(reader);
        Boolean result = Boolean.parseBoolean(value);
    ...
    public static Boolean getBooleanValueFromElement(XMLStreamReader reader, String elementName){
        String value = reader.getAttributeValue(null, elementName);
        Boolean result = Boolean.parseBoolean(value);
    ...
    public static Enum getEnumValueFromElement(XMLStreamReader reader, Class enumType) throws XMLStreamException {
        String value = getValueFromXml(reader);
        Enum result = Enum.valueOf(enumType, value);
